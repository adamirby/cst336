                        ...
                        <ul class="nav navbar-nav mr-auto">
                            <li class="nav-item">
                                <form action="addProduct.php">
                                    <input type="submit" class="btn btn-outline-success" id="beginning" name="addproduct" value="Add Product" />
                                </form>
                            </li>
                            <li class="nav-item">
                                <form action="logout.php" >
                                    <input type="submit" class="btn btn-outline-secondary" id="beginning" value="Logout" />
                                </form>
                            </li>
                        </ul>
